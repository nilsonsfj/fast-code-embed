 ...
 *
 * When disabled (default), the FCE_PROF_* macros cost one load + branch,
...
/* Runtime-active flag. Set once by fce_profile_init() from FCE_PROFILE env. */
extern bool fce_profile_active;

/* Initialize profiling — reads FCE_PROFILE env var. Call once at startup. */
